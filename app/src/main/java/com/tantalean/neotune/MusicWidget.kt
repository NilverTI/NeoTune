...
class MusicWidget : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.tantalean.neotune.ACTION_PLAY_PAUSE"
        const val ACTION_PREV = "com.tantalean.neotune.ACTION_PREV"
        const val ACTION_NEXT = "com.tantalean.neotune.ACTION_NEXT"
        const val ACTION_SHUFFLE = "com.tantalean.neotune.ACTION_SHUFFLE"
        const val ACTION_LIKE = "com.tantalean.neotune.ACTION_LIKE"
        const val ACTION_REPLAY = "com.tantalean.neotune.ACTION_REPLAY"
        const val ACTION_OPEN_APP = "com.tantalean.neotune.ACTION_OPEN_APP"
        const val ACTION_STATE_CHANGED = "com.tantalean.neotune.ACTION_STATE_CHANGED"
        const val ACTION_UPDATE_PROGRESS = "com.tantalean.neotune.ACTION_UPDATE_PROGRESS"
